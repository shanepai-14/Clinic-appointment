          ...
          <option value=" {{$doctors->name }}"> {{$doctors->name }}--speciality-- {{$doctors->speciality}}</option>
                    ...
                    <div class="col-12 py-2 wow fadeInUp" data-wow-delay="300ms">
                        <select name="appointment_for" id="" class="form-control">
                            ...
                            <option value="My Self" {{ old('appointment_for') == 'My Self' ? 'selected' : '' }}>My Self</option>
                            <option value="My Spouse" {{ old('appointment_for') == 'My Spouse' ? 'selected' : '' }}>My Spouse</option>
                            <option value="My Child" {{ old('appointment_for') == 'My Child' ? 'selected' : '' }}>My Child</option>
                            <option value="My Sister" {{ old('appointment_for') == 'My Sister' ? 'selected' : '' }}>My Sister</option>
                            <option value="My Brother" {{ old('appointment_for') == 'My Brother' ? 'selected' : '' }}>My Brother</option>
                            <option value="My Cousin" {{ old('appointment_for') == 'My Cousin' ? 'selected' : '' }}>My Cousin</option>
                            <option value="My Mother" {{ old('appointment_for') == 'My Mother' ? 'selected' : '' }}>My Mother</option>
                            <option value="My Father" {{ old('appointment_for') == 'My Father' ? 'selected' : '' }}>My Father</option>
                            <option value="My Uncle" {{ old('appointment_for') == 'My Uncle' ? 'selected' : '' }}>My Uncle</option>
                            <option value="My Auntie" {{ old('appointment_for') == 'My Autie' ? 'selected' : '' }}>My Auntie</option>
                            <option value="My Friend" {{ old('appointment_for') == 'My Friend' ? 'selected' : '' }}>My Friend</option>
                        </select>
