...
<nav class="navbar navbar-expand-lg navbar-light shadow-sm">
    <div class="container">
        <a class="navbar-brand brand-logo-mini" href="/home"><img src="{{ asset('../assets/img/custom-logo.png') }}"
            alt="Custom Logo" style="border-radius: 50%; width: 100px; height: 50px;"></a>
